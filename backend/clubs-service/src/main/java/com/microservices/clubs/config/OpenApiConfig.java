package com.microservices.clubs.config;
...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI clubsServiceAPI() {
        Server devServer = new Server();
        devServer.setUrl("http://localhost:8085");
        devServer.setDescription("Development Server");
        
        Server prodServer = new Server();
        prodServer.setUrl("http://localhost:8080/api/clubs");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("API pour la gestion des clubs étudiants")
                .contact(contact);
